#' Conduct.PhylogeneticRegression_PIC_MM: function to conduct phylogenetic regression using PIC and MM estimator
#'
...
#' @return handle.PIC_MM Object containing results of MM regression for PIC
#' @export
#' @examples
#' 
#' ################
...
#' ######################################
#' summary(Conduct.PhylogeneticRegression_PIC_MM(handle.Phylogeny = handle.Phylogeny, vector.Trait_X = vector.TraitValue_X, vector.Trait_Y = vector.TraitValue_Y))


#########################################
# Conduct.PhylogeneticRegression_PIC_MM #
#########################################
Conduct.PhylogeneticRegression_PIC_MM <- function(handle.Phylogeny, vector.Trait_X, vector.Trait_Y){
  ...
  #########################
  handle.PIC_MM <- lmRob(formula = vector.PIC_Y~vector.PIC_X-1)
  
  ##########
  # return #
  ##########
  return(handle.PIC_MM)
