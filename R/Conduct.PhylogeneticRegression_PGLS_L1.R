#' Conduct.PhylogeneticRegression_PGLS_L1: function to conduct phylogenetic regression using PGLS and L1 estimator
#'
...
#' @return handle.PGLS_L1 Object containing results of L1 regression for PGLS
#' @export
#' @examples
#' ################
#' # load depends #
...
#' ######################################
#' Conduct.PhylogeneticRegression_PGLS_L1(handle.Phylogeny = handle.Phylogeny, vector.Trait_X = vector.TraitValue_X, vector.Trait_Y = vector.TraitValue_Y)

##########################################
# Conduct.PhylogeneticRegression_PGLS_L1 #
##########################################
Conduct.PhylogeneticRegression_PGLS_L1 <- function(handle.Phylogeny, vector.Trait_X, vector.Trait_Y){
  ...
  #########################
  handle.PGLS_L1 <- lad(formula = vector.Projected_Trait_Y~matrix.Design_Projected_Trait_X-1, method = "EM")
  
  ##########
  # RETURN #
  ##########
  return(handle.PGLS_L1)
