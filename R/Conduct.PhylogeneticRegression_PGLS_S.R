#' Conduct.PhylogeneticRegression_PGLS_S: function to conduct phylogenetic regression using PGLS and S estimator
#'
...
#' @return handle.PGLS_S Object containing results of S regression for PGLS
#' @export
#' @examples
#' 
#' ################
...
#' ######################################
#' Conduct.PhylogeneticRegression_PGLS_S(handle.Phylogeny = handle.Phylogeny, vector.Trait_X = vector.TraitValue_X, vector.Trait_Y = vector.TraitValue_Y)
#' 


##########################################
# Conduct.PhylogeneticRegression_PGLS_S #
##########################################
Conduct.PhylogeneticRegression_PGLS_S <- function(handle.Phylogeny, vector.Trait_X, vector.Trait_Y){
  ...
  #########################
  # Compute S regression #
  #########################
  handle.PGLS_S <- lmRob(formula = vector.Projected_Trait_Y~matrix.Design_Projected_Trait_X-1, estim="Initial")
  
  ##########
  # RETURN #
  ##########
  return(handle.PGLS_S)
